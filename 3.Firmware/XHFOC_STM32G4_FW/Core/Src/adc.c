...
void HAL_ADC_MspInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  */
    ...
    PB12     ------> ADC1_IN11
    */
    GPIO_InitStruct.Pin = M0_IC_Pin|M0_IB_Pin|M0_IA_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = M0_HALL_C_Pin|NTC_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
  ...
  */
    ...
    PC5     ------> ADC2_IN11
    */
    GPIO_InitStruct.Pin = M0_VA_Pin|M0_VB_Pin|M0_VC_Pin|ADSPE_Pin
                          |M0_VBUS_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = M0_HALL_A_Pin|M0_HALL_B_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PB12     ------> ADC1_IN11
    */
    HAL_GPIO_DeInit(GPIOA, M0_IC_Pin|M0_IB_Pin|M0_IA_Pin);

    HAL_GPIO_DeInit(GPIOB, M0_HALL_C_Pin|NTC_Pin);
  ...
  /* USER CODE END ADC2_MspDeInit 0 */
    ...
    PC5     ------> ADC2_IN11
    */
    HAL_GPIO_DeInit(GPIOC, M0_VA_Pin|M0_VB_Pin|M0_VC_Pin|ADSPE_Pin
                          |M0_VBUS_Pin);

    HAL_GPIO_DeInit(GPIOA, M0_HALL_A_Pin|M0_HALL_B_Pin);
...
void AdcStartDmaSampling(void)
{
  ...
  if (HAL_ADC_Start_DMA(&hadc1, (uint32_t *)adc1_regular_dma_buf, ADC1_REGULAR_CHANNEL_COUNT) != HAL_OK)
  {
    return;
  }

  if (HAL_ADC_Start_DMA(&hadc2, (uint32_t *)adc2_regular_dma_buf, ADC2_REGULAR_CHANNEL_COUNT) != HAL_OK)
  {
    (void)HAL_ADC_Stop_DMA(&hadc1);
    return;
  }
...
{
  return AdcRawToVoltage(AdcGetRaw(signal));
}
